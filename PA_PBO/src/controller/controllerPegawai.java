...
public class controllerPegawai implements implementPegawai {
    ...
    final String insert = "INSERT INTO pegawai (id_pegawai, nama_pegawai, alamat_pegawai, jabatan) VALUES (?,?,?,?);";
    final String update = "UPDATE pegawai set nama_pegawai=?, alamat_pegawai=?, jabatan=? WHERE id_pegawai=?;";
    ...
    public void update (modelPegawai b) {
        ...
        try {
            ...
            statement.setString(4, b.getId_pegawai());
            statement.executeUpdate();
    ...
    @Override
    public List<modelPegawai> getcariPegawai(String nama_pegawai){
        ...
        try {
            ...
            while (rs.next()){
                ...
                mm.setNama_pegawai(rs.getString("nama_pegawai"));
                mm.setAlamat_pegawai(rs.getString("alamat_pegawai"));
                mm.setJabatan(rs.getString("jabatan"));
                lb.add(mm);
            }
        }catch (SQLException ex) {
    ...
    @Override
    public List<modelPegawai> getALLPegawai(){
        List<modelPegawai> lb = null;
        try {
            lb = new ArrayList<modelPegawai>();
