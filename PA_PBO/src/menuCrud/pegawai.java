...
public class pegawai {
   ...
   List<modelPegawai> listpegawai;
    ...
    public pegawai(Crudpegawai frameMenu) {
        ...
        listpegawai = Implementpegawai.getALLPegawai();
    }
     ...
     public void isiTabelCariNama(){
        listpegawai = Implementpegawai.getcariPegawai(frameMenus.getTxtCariPegawai().getText());
        modeltabelpegawai mtp = new modeltabelpegawai (listpegawai);
        frameMenus.getTabelModelPegawai().setModel(mtp);
    }
     
      public void cariNama(){
        if(!frameMenus.getTxtCariPegawai().getText().trim().isEmpty()){
            Implementpegawai.getcariPegawai(frameMenus.getTxtCariPegawai().getText());
            isiTabelCariNama();
        } else {
